...
module.exports = (robot) ->
  ...
  robot.hear /brace yourselves (.+)/i, (msg) ->
    memeGenerator msg, 'http://i.imgur.com/cOnPlV7.jpg', 'Brace Yourselves', msg.match[1], (url) ->
      msg.send url

  robot.hear /(.*) (ALL the .*)/i, (msg) ->
    # do not do this if strings before or after <all the> are more than 5 words
    return if msg.match[1].split(" ").length > 5 or msg.match[2].split(" ").length > 5
